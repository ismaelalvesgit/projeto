...
<head>
  ...
  -->
  <link rel="stylesheet" href="/rest/admin/dist/css/skins/skin-blue.min.css">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            ...
            <ul class="dropdown-menu">
              <li class="header">Voçe recebeu 4 messagens</li>
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <!-- User Image -->
                        <img src="/rest/admin/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                      </div>
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="/rest/admin/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
